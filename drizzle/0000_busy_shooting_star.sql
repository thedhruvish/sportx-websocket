...
CREATE INDEX "idx_live_events_match_id" ON "live_events" USING btree ("match_id");--> statement-breakpoint
CREATE INDEX "idx_live_events_created_at" ON "live_events" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "idx_live_events_match_sequence" ON "live_events" USING btree ("match_id","event_sequence");--> statement-breakpoint
